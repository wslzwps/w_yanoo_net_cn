...
if($_GET['act']=='add'){
	...
	$long=str_replace('m.toutiao.com','toutiao.com',$long);
	}
	...
	$vid=cut($html,'vid=','&');//获取视频ID
	  ...
	  if(stristr($long,"mp.weixin.qq.com")){
		...
		"gongzhonghao"=>array(".profile_nickname:first","text"),
		...
		"ywyuedu"=>10000,
	   	...
	   	$caiji = array(
		"title"=>array(".acTxtTit h1","text"),
		"content"=>array("#icontent","html"),
		"gongzhonghao"=>"手机凤凰",
		"ywyuedu"=>10000,
		);
	...
	$sql = "insert into tbl_info values (0,'".$title."','".addslashes($content)."','".$rowad['ad_img']."','".$rowad['ad_link']."','".$_COOKIE['username']."',0,0,'".date('Y-m-d')."','".$rowad['adtelnumber']."','".$ifadtop."','".$gongzhonghao."','".$ifPublicNumber."','".$rowad['erweima']."','".$ywyuedu."','".$infoid."','".$daili."','".(int)$_POST['adid']."','".(int)$_POST['adquanping']."','".(int)$_POST['music']."','".(int)$_POST['autoplay']."')";
...
<div class="apply" id="apply">
	...
	-->
        <dl class="clearfix">
		<dd>广告位置：<label>顶部 <input type="radio" name="adweizhi" value="4" id="adweizhitop" /></label>
           ...
           <dd style="display:none"> <span style="margin-left:16px;">公众号：</span><label>显示 <input type="radio" name="ifgongzhonghao" value="1" checked="CHECKED" /></label>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 15px;">
		  <tr>
		    ...
		    <td align="center"><a href="http://news.qq.com/"><img src="images/ico1.jpg" width="59" height="59" border="0"></a></td>
