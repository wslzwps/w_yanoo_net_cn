<div class="bot_main">
	<ul>
		<li class="ico_1" onclick="window.location.href='register.php'" style="width:25%"><span class="ico"><img src="images/1.png" /></span><span class="txt">帐号注册</span></li>
		<li class="ico_2" onclick="window.location.href='syjc.php'" style="width:25%"><span class="ico"><img src="images/2.png" /></span><span class="txt">使用教程</span></li>
        ...
        <ul id="tr1">
         <li><a href="kefu.php">开通会员</a></li>
        <li><a href="kefu.php">开通代理</a></li>
