...
/*	if($_GET["act"]=="search" && $_POST['title']!='')
    ...
    <tr height="35px">
		...
		<td>
		<a href="adminkaihushu.php?id=<?=$row['id']?>"  class="tablelink"> 修改开户数</a> 
		<a href="adminlist.php?id=<?=$row['id']?>&act=del" onclick="if (confirm('确定要删除吗？')) return true; else return false;" class="tablelink"> 删除</a></td>
    </tr>
    <?
	}
	?>    
