...
//		exit;
		...
		if($row){
			...
			exit;
			//echo '正在加载<br>三秒后自动跳转';
		}else{
			qy_close();
			header("refresh:3;url=login.php");
			echo '账号或密码错误，请重新登录<br>三秒后自动跳转';
			exit;
		}
	}
}
...
<div class="logintop">    
    ...
    <li><a href="#">回首页</a></li>
    <li><a href="#">帮助</a></li>
    <li><a href="http://www.huosutui.com">关于</a></li>
    </ul>    
    </div>
    ...
    <div class="loginbm">Copyright © 2016-2017 <a href="http://yanoo.net.cn" target="_blank">亚努信息科技</a> All Rights Reserved ·</div>	
