			...
			<li>
				<div class="list_txt">
					...
					<span style="float:right;font-size:12px;margin-right:10px;margin-top:-33px">
						<a href="ad_list.php?id=<?=$row['id']?>&act=del&page=<?=$_GET['page']?>" onClick="if (confirm('确定要删除吗？')) return true; else return false;">删除</a>
						&nbsp;&nbsp;
						<a href="ad_edit.php?id=<?=$row['id']?>&act=updata">修改</a>
					</span>
				</div>
			</li>
			<?
